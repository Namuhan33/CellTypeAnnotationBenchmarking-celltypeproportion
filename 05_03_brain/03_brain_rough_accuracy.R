...
evaluation_pbmc_rough_accuracy <- function(method, prop){
  ...
  for (i in 1:length(method)) {
    ...
    saving.path <- paste0("08_StartOver_NewStory/05_interdatasets/03_brain/03_evaluation/", method[i],"/", prop,"/evaluating_rough_accuracy.csv")
...
for(i in 1:14){
  prp = paste0("P", i)
  evaluation_pbmc_rough_accuracy(method, prp)
}
